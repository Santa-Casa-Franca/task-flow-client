...
import UploadAuxiliaryServices from './UploadAuxiliaryServices';


const AuxiliaryServices: React.FC<{ serviceId: number, templateId: number }> = ({ serviceId, templateId }) => {
    const [selectedItem, setSelectedItem] = useState(0);

    const renderComponent = () => {
        switch (selectedItem) {
            case 0:
                return <UploadAuxiliaryServices serviceId={serviceId} templateId={templateId} />
