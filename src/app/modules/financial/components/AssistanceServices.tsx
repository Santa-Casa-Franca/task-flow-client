...
import UploadAssistanceServices from './UploadAssistanceServices';


const AssistanceServices: React.FC<{ serviceId: number, templateId: number }> = ({ serviceId, templateId }) => {
    const [selectedItem, setSelectedItem] = useState(0);

    const renderComponent = () => {
        switch (selectedItem) {
            case 0:
                return <UploadAssistanceServices serviceId={serviceId} templateId={templateId} />
