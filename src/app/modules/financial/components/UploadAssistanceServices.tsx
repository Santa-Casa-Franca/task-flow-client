...
const CONFIG: any = {
    ...
    taquaritinga: {
        assistance: { start: 6, end: 28, headers: ["Assistenciais", "Exame", "Procedimento", "Qtde. Consultas", "Custo unitário s/ Exame", "Custo total s/ Exame", "Nº de Exames", "Custo unitário c/ Exame", "Custo total c/ Exame"], cols: [0, 1, 5, 9, 11, 15, 18, 21, 24] },
        notDoctor: { start: 32, end: 39, headers: ["Não Médicos", "Nº de Consultas", "Nº de Sessões", "Total", "Custo unitário s/ Exame", "Total Custo unitário s/ Exame", "Nº de Exames", "Custo unitário c/ Exame", "Total Custo unitário c/ Exame"], cols: [0, 2, 3, 6, 10, 13, 16, 19, 23] },
    },
